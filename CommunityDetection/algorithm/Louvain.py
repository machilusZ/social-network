...
overall=l_accuracy('/Users/feng/Desktop/social_network_project/facebook/348.edges','/Users/feng/PycharmProjects/social_PJ/facebook/348.circles')
print(overall) 
'''
if __name__ == '__main__':
    G = load_graph('/Users/feng/Desktop/social_network_project/facebook/0.edges')
    algorithm = Louvain(G)
    communities = algorithm.execute()
